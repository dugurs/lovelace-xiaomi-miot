...
## 설치
HACS > fontend > Custom repositories add > `dugurs/lovelace-xiaomi-miot`<br>
HACS > fontend > ➕ EXPLORE & DOWNLOAD REPOSITORIES > `xiaomi-miot` > DOWNLOAD THIS REPOSITORY
